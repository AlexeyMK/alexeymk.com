...
When I first became a Growth Engineer,  Iwas automatically enrolled into absolutely nothing. In retrospect, this seems strange. [Growth Engineering is quite different from the rest of Software Engineering](http://TODO LINK).  How was I supposed to pick things up?

![](/images/experimentation-is-hard.png)

As it turned out, many of the skills from starting [Hacker Paradise](http://hackerparadise.org)  were transferrable: be scrappy, focus on the funnel, and talk to customers.  A year in, I enrolled in one of Reforge’s original [Growth Series](https://www.reforge.com/courses/growth-series) courses. This helped me get a handle on the foundations I’d been missing when I accidentally taught Growth Engineering to myself.
...
When I moved to Japan and [transitioned to advising](http://alexeymk.com/growth-eng) a few years later, I ended up adapting the material for companies like Coinbase, Brex, Levels Health and many more.

The upcoming [Growth Engineering Course](https://www.reforge.com/courses/growth-engineering/) is the natural continuation of my mission to help Growth Engineers be awesome.  Here’s a bit more about it:
...
- Product Managers: see [Reforge’s great selection of courses](https://www.reforge.com/courses/), in particular [Technical Foundations for PMs](https://www.reforge.com/courses/technical-foundations-for-product-managers/details) if that’s what you’re looking for
- Early stage companies: see this course on [finding Product Market Fit](https://www.reforge.com/courses/finding-product-market-fit/details)
- Enterprise Sales companies: if you don’t have enough potential customers to be able to get into “fast iteration” mode, a lot of the content won’t apply to you.
