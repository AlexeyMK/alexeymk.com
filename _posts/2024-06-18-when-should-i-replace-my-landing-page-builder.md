...
| Compatability      | ⭐️⭐<br>This is a pain. In past jobs, we end up writing a custom JS snippet that goes on every page to handle analytics & monitoring.  Experimentation-wise, you’re stuck using the LBP’s system. For QA, it’s possible to [restrict publishing to admins](https://instapage.com/en/features/read-only-team-members) only, but there is no equivalent of a “Pull Request” | ⭐️⭐⭐⭐<br>Honestly, one of the biggest benefits of going custom is that your testing, monitoring, experimentation and analytics **just works.**                                                         |
...
At MasterClass, we had an engineering team focused on Landing Pages as our 3rd Growth Pod. Even at that point, we’d still use a LBP to iterate on new landing page designs, and only move them into “engineering land” once they became clear winners.  For many companies, the correct answer to “when do we outgrow LBPs” may well be “never.”  This simply means that you keep finding higher-ROI ways to deploy your Growth Engineers. That’s well worth being proud of.
